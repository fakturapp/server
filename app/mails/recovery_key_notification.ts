...
export default class RecoveryKeyNotification extends BaseMail {
  ...
  prepare() {
    ...
    const content = `
      <h2 style="font-size: 20px; font-weight: 600; color: #171717; letter-spacing: -0.02em; margin: 0 0 8px; text-align: center;">Votre clef de secours</h2>
      ...
      <table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin: 28px 0;">
        <tr><td align="center">
          <table cellpadding="0" cellspacing="0" border="0"><tr><td style="padding: 20px 28px; background: #f5f5f5; border: 2px dashed rgba(89,87,232,0.3); border-radius: 16px; font-family: 'Courier New', Courier, monospace; font-size: 15px; font-weight: 700; color: #171717; letter-spacing: 1.5px; word-break: break-all; text-align: center;">
            ${formatted}
          </td></tr></table>
        </td></tr>
      </table>
