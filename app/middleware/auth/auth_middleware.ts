...
// Authenticated routes that non-admins must still reach when ADMIN_ONLY is on,
// so the frontend can identify the user and sign them out.
...
export default class AuthMiddleware {
  async handle(
    ...
    // Admin-only lockdown: applies to everything that requires auth.
