...
const TEMPLATES: Record<string, TemplateConfig> = {
  classique: {
    ...
    showAccentBar: true, borderRadius: '10px',
  },
  sombre: {
    id: 'sombre', layout: 'standard', docBg: '#1c1c21', text: '#e4e4e7', textMuted: '#a1a1aa', textFooter: '#71717a',
    clientBlockBg: '#27272a', clientBlockBorder: '#3f3f46', rowEven: '#1c1c21', rowOdd: '#222226', borderLight: '#3f3f46',
    totalBg: '15', totalBorder: '30', footerBorder: '#3f3f46', signatureBorder: '#3f3f46',
    paymentBadgeBg: '#27272a', paymentBadgeBorder: '#3f3f46', paymentBadgeText: '#a1a1aa',
    showAccentBar: true, borderRadius: '10px',
  },
  moderne: {
    ...
    showAccentBar: false, borderRadius: '8px',
  },
  compact: {
    ...
    showAccentBar: false, borderRadius: '0px',
  },
  elegance: {
    ...
    showAccentBar: false, borderRadius: '6px',
  },
  audacieux: {
    ...
    showAccentBar: false, borderRadius: '12px',
  },
  lateral: {
  ...
  minimaliste: {
    ...
    showAccentBar: false, borderRadius: '4px',
  },
  duo: {
    ...
    showAccentBar: false, borderRadius: '10px',
  },
  ligne: {
...
export function getTemplate(id?: string): TemplateConfig {
  if (!id) return TEMPLATES.classique
