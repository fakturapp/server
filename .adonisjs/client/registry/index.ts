...
const routes = {
  ...
  'apiPlatform.meta.ping': {
    ...
    tokens: [{"old":"/api/platform/ping","type":0,"val":"api","end":""},{"old":"/api/platform/ping","type":0,"val":"platform","end":""},{"old":"/api/platform/ping","type":0,"val":"ping","end":""}],
    types: placeholder as Registry['apiPlatform.meta.ping']['types'],
  },
  'apiPlatform.meta.session': {
    methods: ["GET","HEAD"],
    pattern: '/api/platform/session',
    tokens: [{"old":"/api/platform/session","type":0,"val":"api","end":""},{"old":"/api/platform/session","type":0,"val":"platform","end":""},{"old":"/api/platform/session","type":0,"val":"session","end":""}],
    types: placeholder as Registry['apiPlatform.meta.session']['types'],
  },
  'apiPlatform.meta.usage': {
    methods: ["GET","HEAD"],
    pattern: '/api/platform/usage',
    tokens: [{"old":"/api/platform/usage","type":0,"val":"api","end":""},{"old":"/api/platform/usage","type":0,"val":"platform","end":""},{"old":"/api/platform/usage","type":0,"val":"usage","end":""}],
    types: placeholder as Registry['apiPlatform.meta.usage']['types'],
  },
  'apiPlatform.notFound': {
    methods: ["HEAD","OPTIONS","GET","POST","PUT","PATCH","DELETE"],
    pattern: '/api/platform/*',
    tokens: [{"old":"/api/platform/*","type":0,"val":"api","end":""},{"old":"/api/platform/*","type":0,"val":"platform","end":""},{"old":"/api/platform/*","type":2,"val":"*","end":""}],
