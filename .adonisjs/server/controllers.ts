...
export const controllers = {
  ...
  dashboard: {
    apiKeys: {
      ...
      WebhookDeliveryConfigShow: () => import('#controllers/dashboard/api_keys/webhook_delivery_config_show'),
      WebhookDeliveryConfigUpdate: () => import('#controllers/dashboard/api_keys/webhook_delivery_config_update'),
      WebhookDeliveryConfig: () => import('#controllers/dashboard/api_keys/webhook_delivery_config'),
    ...
    apiProjects: {
      ...
      ExplorerEvent: () => import('#controllers/dashboard/api_projects/explorer_event'),
